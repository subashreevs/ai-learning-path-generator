...
A full-stack AI application that generates personalized step-by-step learning roadmaps based on text input, topics, or PDF resumes.

Tech: FastAPI, React + TS, Tailwind, Axios, Python, pypdf, Llama 3.1 via Ollama
